...
def train(emb_model, model, loss_fn, optimizer, train_dataloader, val_dataloader=None,
          epochs=5, bert_layer = 0, emb_model_save_directory=wandb.run.dir,
          model_save_directory=wandb.run.dir):
    """Train the CNN model."""
